...
\title{Building a Best Buy Store \\ Interactive Webpage \\ Using Django and SQLite3} % Report title

\author{Morgan \textsc{Brockman} \& \\ Ian \textsc{Fleming}} % Author name(s), add additional authors like: '\& James \textsc{Smith}'

\date{09 March 2022} % Date of the report
...
\begin{center}
	\begin{tabular}{l r}
		Instructor: & Hasan \textsc{Jamil} \\ % Instructor/supervisor
